...
!(function (a) {
  ...
  var b = a(window),
    ...
    l = function (b, c) {
      (this.form = b),
        (this.$form = a(b)),
        (this.defaults = a.extend({}, l.DEFAULTS, a.isPlainObject(c) ? c : {})),
        this.init();
    };
  (l.prototype = {
    constructor: l,
    ...
    initStorage: function () {
      var b,
        ...
        f = this.key,
        g = new Date(),
        h = { date: g, maxAge: e.maxAge, caches: [] };
      c && (b = c.getItem(f)),
        !b && d && (b = d.getItem(f)),
        (b = "string" == typeof b ? JSON.parse(b) : null),
        a.isPlainObject(b)
          ? "number" == typeof b.maxAge &&
            (g - new Date(b.date)) / 1e3 > b.maxAge &&
            (b = h)
          : (b = h),
        (this.storage = b);
    },
    addListeners: function () {
      this.defaults.autoStore &&
        (this.$controls.on(h, a.proxy(this.change, this)),
        b.on(i, a.proxy(this.beforeunload, this)));
    },
    removeListeners: function () {
      this.defaults.autoStore &&
        (this.$controls.off(h, this.change), b.off(i, this.beforeunload));
    },
    change: function (b) {
      var c,
        d,
      ...
      h &&
        ((c = h.replace(g, "")),
        this.$controls.filter('[name*="' + c + '"]').each(function () {
          j(e) ? i.push(this.checked) : ((d = a(this).val()), d && i.push(d));
        }),
        i.length &&
          (this.update(h, i),
          clearTimeout(this.storing),
          (this.storing = setTimeout(a.proxy(this.store, this), 1e3))));
    },
      ...
      return (
        this.$controls.each(function () {
          ...
          f &&
            ((c = b[f]),
            (c = a.isArray(c) ? c : []),
            j(this) ? c.push(this.checked) : ((d = e.val()), d && c.push(d)),
            c.length && (b[f] = c));
        }),
        b
      );
    ...
    setCache: function (b, c) {
      typeof c === e && ((c = b), (b = 0 / 0)),
        a.isPlainObject(c) &&
          ((b = k(b) || this.index), (this.caches[b] = c), this.store());
    },
    ...
    outputCache: function (b) {
      ...
      a.isPlainObject(c) &&
        ((this.activeIndex = k(b) || this.index),
        (c = a.extend(!0, {}, c)),
        this.$controls.each(function () {
          var b,
            d,
          ...
          f &&
            ...
            a.isArray(b) &&
              b.length &&
              ((d = b.shift()), j(this) ? (this.checked = d) : e.val(d)));
        }));
    },
    store: function () {
      var a = this.storage,
