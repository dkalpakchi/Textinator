...
#  Default: 'jupyterhub.auth.PAMAuthenticator'
from auth import TextinatorAuthenticator
c.JupyterHub.authenticator_class = TextinatorAuthenticator
...
#  Default: 'http://:8000'
c.JupyterHub.bind_url = 'http://:8345'
...
c.CongigurableHTTPProxy.should_start = True
